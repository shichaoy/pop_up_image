...
{  
  ...
  pop_up_obj.get_plane_equation(transToWolrd, pop_up_obj.ground_seg2d_lines_connect);   //currently 0.9ms
...
//   cout<<"class ground_seg2d_lines_open "<<pop_up_obj.ground_seg2d_lines_open<<endl;
...
//   cout<<"good_plane_indices  "<<pop_up_obj.good_plane_indices<<endl;
//   
  ...
  pop_up_obj.generate_cloud(raw_img,transToWolrd,true, true,10.0);   //currently 0.047s  could use downsample
